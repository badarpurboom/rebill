...
# 2. Create Excel file (.xlsx)
df = pd.DataFrame(menu_data, columns=columns)
df.to_excel("radhe_sweets_menu.xlsx", index=False)

print(f"Generated CSV with {len(menu_data)} items -> radhe_sweets_menu.csv")
print(f"Generated Excel with {len(menu_data)} items -> radhe_sweets_menu.xlsx")
